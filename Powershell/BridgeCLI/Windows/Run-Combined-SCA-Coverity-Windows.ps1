<#
.SYNOPSIS
    Executes both Black Duck SCA and Coverity scans using Bridge CLI on Windows
...
.EXAMPLE
    .\Run-Combined-SCA-Coverity-Windows.ps1 -BlackDuckUrl "https://bd.example.com" -BlackDuckToken "token" -CoverityUrl "https://cov.example.com" -CoverityUser "admin" -CoverityPassword "pass" -ProjectName "MyApp" -ProjectVersion "main" -StreamName "MyApp-main"
#>
...
Write-Host "Combined SCA + Coverity Scan - Windows" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
